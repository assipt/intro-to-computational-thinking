...
# ╔═╡ 6a7a8c61-e3cc-4596-8075-8400c68cfe98
...
# ╔═╡ 586b0750-920d-45d9-83b2-773f5a888874
using Measurements

# ╔═╡ 64442d8a-93b7-454e-a4e1-444986c8f9dd
using PlutoUI

# ╔═╡ a7fb9282-1cd4-11ed-236c-39a4d9de8482
md"""

# Exemplo: equações diferenciais e composição

Vamos brincar com a equação mais simples:

$\frac{du}{dt} = p\cdot u$

"""

# ╔═╡ 66f9d039-c031-4286-bea2-19de0ca6a9ff
f(u,p,t) = p*u

# ╔═╡ e3fe1e8d-97a7-4028-8f32-7e2155f85589
u0 = 1/2

# ╔═╡ 9612616e-3a60-4aa9-bd36-c572bd983ef4
tspan = (0.0, 1.0)

# ╔═╡ 6f05103a-4938-4614-83ad-a489388417af
prob = ODEProblem(f, u0, tspan, 1.01)

# ╔═╡ 8248caab-4c19-40d8-b139-9c2c98d22703
sol = solve(prob, Tsit5())

# ╔═╡ e9541838-219f-403d-923b-f0681ad95bd0
plot(sol)

# ╔═╡ acb1ed3d-abbd-4509-9eaa-bbee9137858b
tspan_b = (0.0±0.0, 1.0±0.0)

# ╔═╡ 3d03b325-8e0a-43b3-99ed-88617cdd7907
md"""
Controle a incerteza:
$(@bind incert Slider(0.0:0.01:0.2))
"""

# ╔═╡ 0234410f-c432-4245-ab2e-d8dce4db95d0
u0_b = 1/2 ± incert

# ╔═╡ 12b0fcf4-e861-4c98-96d7-fa17594ac731
prob_b = ODEProblem(f, u0_b, tspan_b, 1.01)

# ╔═╡ 532e7288-d62d-4b1e-b3c2-d14f38f7398d
sol_b = solve(prob_b, Tsit5(), reltol=1e-8, abstol=1e-8)

# ╔═╡ 4dc70473-86b5-4ba2-b845-9bfceac35a8b
plot(sol_b.t, sol_b.u)

# ╔═╡ 16e50d0f-76c3-4a4d-9ee0-929405af31e7
sol_b.u
