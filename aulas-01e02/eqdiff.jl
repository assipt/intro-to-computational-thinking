...
# ╔═╡ b430aeb7-2965-4b34-be34-6295760f12b9
# Carregar as bibliotecas
# Como tem mais de uma linha, precisamos de um bloco begin...end
begin
	# O Pluto tem um gerenciador de pacotes embutido.
	using DifferentialEquations # Solução de equações diferenciais
	using Plots # Plotar os resultados
	using Measurements # Grandezas com incertezas
	using PlutoUI # Interatividade
end

# ╔═╡ bb853f30-1cdf-11ed-399f-33dcd86017c9
md"""

# Equações diferenciais e composição

Aqui vamos brincar com a equação diferencial mais simples que existe:

$\frac{du}{dt} = p\cdot u$
"""

# ╔═╡ 9363e46a-3770-45b1-8827-cb158e73c508
# Definindo a equação diferencial
f(u,p,t) = p*u

# ╔═╡ 57e4dcb4-79ca-4a5e-9591-c47e8f48bd35
md"""
## Resolvendo a equação diferencial
"""

# ╔═╡ 375b3b2f-2af0-4a24-9234-da57358251db
sol1 = let
	u0 = 1/2 # Chute inicial
	tspan = (0.0, 1.0) # Intervalo de integração
	prob = ODEProblem(f, u0, tspan, 1.01)  # Definindo o problema
	solve(prob, Tsit5())
end
	

# ╔═╡ 87023533-219c-4759-87c7-a08b6b4c3a7a
plot(sol1)

# ╔═╡ 125e7f4e-432a-4024-9c5d-e90921ceaba7
md"""
## Será que funciona com incerteza?
"""


# ╔═╡ 2ac46b88-0a6e-4ffb-bfdd-ab1c9f46b6b7
md"""
Incerteza do chute inicial: $(@bind δu Slider(0.0:0.01:0.2, default=0.0))
"""



# ╔═╡ a6a79aa4-9d58-42d8-8b29-0dddeed1ca7e
sol2 = let uinit=1/5, δu=δu, p=1.01
	u₀ = uinit ± δu
...
# ╔═╡ 09c720ae-3cf2-46c0-8895-6e9674a13d45
plot(sol2.t, sol2.u)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "4c8a70272d4d2977586e7b139c6ebfa29d5d8694"
