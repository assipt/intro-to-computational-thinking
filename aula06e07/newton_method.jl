...
# ╔═╡ 39d06c5e-4981-43cc-bbcf-9362f15b7cc8
...
# ╔═╡ 591cf22e-6388-40ff-8e97-bf2d48e98313
...
$J(x) = J(x,y) = \left[\begin{matrix}\frac{\partial T_x}{\partial x} & \frac{\partial T_x}{\partial y}\\ \frac{\partial T_y}{\partial x} & \frac{\partial T_y}{\partial y}\\\end{matrix}\right]$
"""
...
expand(ex) = simplify(ex, expand=true, polynorm=true)
