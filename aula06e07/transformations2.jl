...
# ╔═╡ 983a44e0-1daa-46a6-9bd8-9fe668218ec8
img_original
...
# ╔═╡ 460a8345-4ad5-4e75-951b-50f9aeb82d9f
[(i,j) for i in 1:10, j in 101:110]
...
# ╔═╡ 28a80c29-5990-45be-a9bd-5865ee50f561
f1 = lin([1 2; 3 4])

# ╔═╡ 9f4a3301-5831-455d-b639-953f179b3226
f1([1,2])

# ╔═╡ f19ab419-1d55-4b3f-97b6-7e9396fda49b
[1 2; 3 4] * [1,2]
...
# ╔═╡ c1e718b4-bdd3-4a6b-ba52-0182d5e77b63
...
# ╔═╡ 9a60eb73-523b-4b6c-938e-8f061a5ff471
sqrt(eps(1.0))
...
# ╔═╡ 6164e063-80f9-45b9-b07a-0620d8108edc
A1 = rand(2,2)

# ╔═╡ 19985394-3ad5-4023-8e80-bc4c78d46c51
iA1 = inv(A1)

# ╔═╡ e16885f8-66e7-4714-9a73-27f961fb8ff5
dec = lu(A1)

# ╔═╡ 432aa625-ecbc-4070-8aae-07b111938bfe
let
	v = rand(2)
	iA1 * v, dec\v
end
