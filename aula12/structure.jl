...
# ╔═╡ f5615f0d-b45b-429b-a39d-681b83969eb3
using Plots
...
# ╔═╡ ecb1340a-a88d-4730-9a4a-3475cf5ad51c
println("Imprime algo")

# ╔═╡ e63390ab-5bf4-4513-a5b1-e2277c333c6e
dump(myonehotvector)
...
# ╔═╡ 88fc4cfb-4279-4e46-9724-da85df86094a
D.diag
...
# ╔═╡ 7ad6124e-5afe-4f02-9434-2da2ea144562
Dump(M)
...
# ╔═╡ e1f38d5d-f25a-4803-a07b-20ff045d6dfe
AA = SymTridiagonal(1:10, 1:9)

# ╔═╡ 1a97874f-91f7-4827-bcc9-19c71a5078bc
Dump(AA)

# ╔═╡ 4d2e3ca9-bf5f-49ce-888c-0c26f4d49714
md"""
### Other types of matrices

 * `Tridiagonal`
 * [Banded Matrices](https://github.com/JuliaMatrices/BandedMatrices.jl)
 * [Toeplitz Matrices](https://github.com/JuliaMatrices/ToeplitzMatrices.jl)
 * [Block banded matrices](https://github.com/JuliaMatrices/BlockBandedMatrices.jl)
 * [Some other types of Matrices](https://github.com/JuliaMatrices/SpecialMatrices.jl)
 * [Periodic tridiagonal matrices](https://github.com/pjabardo/TriPMatrices.jl) **Não vai funcionar!**
...
# ╔═╡ eb02bbc2-a835-4924-8612-50e348ef58cd
histogram(randn(10000)) # Distributions
...
# ╔═╡ c095d6d2-8746-447e-a9e3-70b00ef173bb
sqrt(-2)
...
# ╔═╡ ffbfc047-28b9-454d-a496-ae0c2d1e31ac
#factor(outer(rand(3), rand(3)))
...
# ╔═╡ 12a96307-cbb4-45bb-b8cf-2b77653e7716
size(Σr)
...
# ╔═╡ a0ac75d8-1f82-4cb5-99a0-312011b699b5
show_image(myonehotvector)

# ╔═╡ cdee9520-488f-4cbc-b5b0-284c84854d7f
show_image(x)
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "091358406aeffb3c83fc3a859d507789cf4b6b27"
