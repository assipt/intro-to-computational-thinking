...
# ╔═╡ 3977ea8c-a5d2-4f74-a0c9-834c224b30d6
using Plots
...
**OBS.: A precisa ser uma matriz quadrada!**
"""
...
### Vamos plotar os resultados para u₁ e u₂
"""

# ╔═╡ 9c0ce059-3003-4cee-ace6-0a88c0781644
# Criando as funções para 1 e 2
begin
	u₁(t) = (1/3)*exp(-3*t) + 2/3
	u₂(t) = -(1/3)*exp(-3*t) + 1/3
end

# ╔═╡ 71b26bd8-721d-4be0-8e25-d4b5e7f80a9b
begin
	tt = 0:0.1:5
	plot(tt, u₁.(tt), label="u₁", xlabel="t", ylabel="u", linewidth=2)
	plot!(tt, u₂.(tt), label="u₂")
end
