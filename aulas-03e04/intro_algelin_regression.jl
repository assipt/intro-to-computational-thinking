...
# ╔═╡ cfa32648-1e44-4359-9b75-cbb84a48e40d
begin
	using Random
	using Distributions
	using Plots
...
# ╔═╡ d0b868b4-950f-48aa-a555-7ff265948d05
using LinearAlgebra

# ╔═╡ edf96ac8-0974-4d89-87f7-e5fcb163993f
using LsqFit

# ╔═╡ 67e10126-9421-11ec-2bdd-9daa23608ca7
md"""
# Regressão linear
...
Como estamos tratando de um experimento, temos incertezas na medição. 
"""

# ╔═╡ 140f48c5-d5e0-464b-94ea-44605d1e466b
...
# ╔═╡ ac8d37bb-3435-461d-836d-a50604bd5d62
medidas = simdisp(1000,0.0005) # x em metros
...
# ╔═╡ c0f0aca2-4e35-4956-927c-260b024eac95
md"""
**Comparar o coeficiente angular com o valor da rigidez utilizada na simulação**
"""

# ╔═╡ 7ce2dbfd-df14-43e0-894e-9d6c2b651526
# Plotando dados experimentais com ajuste
begin
	scatter(medidas, 5:5:50, label="medidas")
	xlabel!("x(m)")
	ylabel!("F(N)")
	Plots.abline!(coefs[2], coefs[1], linecolor="green", linewidth=2, label="ajuste")
end

# ╔═╡ 95baa3a8-f45b-4037-971a-8cd19382605e
md"""
...
# ╔═╡ a2f21f76-cba5-4713-b2fd-680c9eb305a1
# modelo
@. model(x,p) = p[1]*x + p[2]

# ╔═╡ 4c4c4f74-265a-437d-b4dd-c0f67fdd7f3d
# Chute inicial para a rigidez
p0 = [100.0,0.0]

# ╔═╡ f7bd2916-d5d2-488c-a33e-7c11e6240a18
# encontrando o melhor ajuste
fit = curve_fit(model, medidas, collect(5:5:50), p0)

# ╔═╡ f988fb65-4f9c-46bc-88c9-42018aaa4e26
fit.param

# ╔═╡ bdae9d22-faae-44b9-bad8-36ae04dd1527
# Plotando dados experimentais com ajustes
begin
	scatter(medidas, 5:5:50, label="medidas")
	xlabel!("x(m)")
	ylabel!("F(N)")
	Plots.abline!(coefs[2], coefs[1], linecolor="green", label="ajuste 1", linewidth=2)
	Plots.abline!(fit.param[1], fit.param[2], linecolor="red", linestyle=:dash, label="ajuste 2", linewidth=2)
	
end

# ╔═╡ 1c1fbc7b-0bcc-48bf-818f-b1847f2f072b
md"**Outro pacote que pode ser utilizado é o CurveFit.jl, desenvolvido pelo Pesquisador Paulo Jabardo (IPT)**"
